...
const QuestionBank = () => {
    ...
    const handleAddQuestion = () => {
        ...
        toast({
            title: "Success",
            description: `Question created with ID: ${question.id}`,
        });
    };
                ...
                <div className="flex justify-between items-center mb-8 w-full">
                    ...
                    {isCreating && (
                        <Card className="shadow-lg">
                            ...
                            <CardFooter className='pt-6 border-t flex justify-end gap-4'>
                                <Button variant="outline" onClick={() => setIsCreating(false)}>
                                    Cancel
                                </Button>
                                <Button onClick={handleAddQuestion} className="bg-education-600 hover:bg-education-700">
                                    Create Question
                                </Button>
                            </CardFooter>
                        </Card>
